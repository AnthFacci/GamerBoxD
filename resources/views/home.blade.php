  ...
  <div class="text-white min-vh-100 d-flex flex-column">
    ...
    <div class="container-fluid flex-grow-1 d-flex"> 
      <div class="flex-grow-1 d-flex justify-content-center align-items-center class-custom">
        <div class="normal">
          <img src="{{$data[0]['background_image']}}" alt="Imagem dentro da div" class="img-fluid" />
        </div>
        <div class="normal_three">
          <div class="d-flex justify-content-center align-items-center rounded-circle overflow-hidden custom-round-image1" style="width: 250px; height: 250px;">
            <img src="{{$data[1]['background_image']}}" alt="Imagem dentro da div" class="w-100 h-100" style="object-fit: cover; object-position: center;" />
          </div>  
          <div class="d-flex justify-content-center align-items-center rounded-circle overflow-hidden custom-round-image2" style="width: 250px; height: 250px;">
            <img src="{{$data[2]['background_image']}}" alt="Imagem dentro da div" class="w-100 h-100" style="object-fit: cover; object-position: center;" />
          </div>  
          <div class="d-flex justify-content-center align-items-center rounded-circle overflow-hidden custom-round-image3" style="width: 250px; height: 250px;">
